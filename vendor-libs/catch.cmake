...
INCLUDE( vendor-libs/python_interpreter )
...
IF (WITH_CATCH_SPLIT)
  SET(CATCH_SRC_DIR "${CANCELLAR_BUILD_VENDOR_DIR}/Catch/include")
  ...
  ADD_CUSTOM_COMMAND(
    OUTPUT "${CANCELLAR_BUILD_VENDOR_DIR}/Catch/single_include/catch.hpp"
    COMMAND ${PYTHON_EXECUTABLE} scripts/generateSingleHeader.py
    WORKING_DIRECTORY "${CANCELLAR_BUILD_VENDOR_DIR}/Catch"
  ...
  ADD_CUSTOM_TARGET("catch-builder" ALL 
    ...
    SOURCES "${CANCELLAR_BUILD_VENDOR_DIR}/Catch/single_include/catch.hpp"
  )
