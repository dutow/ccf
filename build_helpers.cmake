...
macro(ccf_ns add)
  ...
  if(NOT DEFINED CCF_BUILD_SCOPE)
    set(CCF_BUILD_SCOPE ${add})
    set(CCF_BUILD_SCOPEDIR ${add})
  else()
    set(CCF_BUILD_SCOPE "${CCF_BUILD_SCOPE}-${add}")
    set(CCF_BUILD_SCOPEDIR "${CCF_BUILD_SCOPEDIR}/${add}")
  endif()
endmacro()
...
MACRO( ADD_TEST_TARGET )
  ...
  TARGET_LINK_LIBRARIES( ${BUILD_SCOPE} ${CCF_TEST_THIRD_PARTY_LIBRARIES} )
ENDMACRO()
