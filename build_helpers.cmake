...
function(ccf_target type)
  ...
  if(type_lower STREQUAL "executable")
    ...
    if(NOT CCF_TEST_MODE)
      # NO parent scope: tests are added within this function
      set(CCF_TEST_DEP "${CCF_BUILD_SCOPE}-objs")
    endif()
  ...
  elseif(type_lower STREQUAL "static_library")
    ...
    set(CCF_TEST_DEP ${CCF_BUILD_SCOPE})
  ...
  set(CCF_TARGETS $CACHE{CCF_TARGETS})
  ...
  foreach(dep ${ARGV})
    ...
    if(TARGET ${dep})
      ...
      if(dep_type STREQUAL "OBJECT_LIBRARY" ) 
        target_sources("${CCF_BUILD_SCOPE}" PUBLIC $<TARGET_OBJECTS:${dep}>)
      endif()
